      ...
      <div className="contain flex items-center justify-between">
        ...
        <nav className={useClass}>
          <div className="menu mt-32 contain flex flex-col font-heading text-3xl tracking-wider items-end">
            ...
            <a className="mb-8 text-offgray hover:text-white" href={'/pdfs/Ian_Trent_Resume_2021.pdf'} target="_blank" rel="noopener noreferrer" onClick={isActive ? toggleMobileMenu : null}>
              Resume
            </a>
          </div>
        </nav>
