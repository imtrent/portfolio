...
const Header = props => {
  ...
  return (
    <header
      className={`sticky top-0 z-50 bg-white py-6 ${scrolling ? "border-b border-border mt-0" : "mt-4"
        }`}
    >
      <div className="contain flex items-center justify-between">
        <Link
          className={`font-heading text-xl tracking-wider z-50 transition-colors duration-300 ${isActive ? "text-white" : "text-primary"
            }`}
          to="/"
        ...
        <div
          ...
          onKeyDown={evt => evt.keyCode === 13 && setIsActive(!isActive)}
        >
        ...
        <nav className={useClass}>
          <div className="menu mt-32 contain flex flex-col font-heading text-3xl tracking-wider items-end">
            <Link
              to="/"
              className={`mb-8 hover:text-white ${location.pathname === "/" ? "text-white active" : "text-offgray"
                }`}
              onClick={isActive ? toggleMobileMenu : null}
            >
              Home
            ...
            <Link
              to="/about"
              className={`mb-8 hover:text-white ${location.pathname === "/about"
                  ? "text-white active"
                  : "text-offgray"
                }`}
              onClick={isActive ? toggleMobileMenu : null}
            ...
            <a
              ...
              href="mailto:ian.m.trent@gmail.com"
              target="_blank"
