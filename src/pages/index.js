...
const IndexPage = () => (
  <Layout>
    <SEO title="Software Developer" description="Ian Trent &mdash; Software Developer based in Lafayette, Indiana." />
    <section className="contain mt-16 mb-32 md:my-32">
      ...
      <h1 className="text-3xl md:text-5xl">Ian Trent &mdash; Software Developer based in Lafayette, Indiana.</h1>
